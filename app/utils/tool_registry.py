...
class ToolRegistry:
    ...
    def _initialize_tools(self):
        ...
        try:
            ...
            from app.tools.directmail_personalization import (
                DirectMailPersonalizationTool,
            )
            ...
            self.register_tool(
                "directmail_personalization", DirectMailPersonalizationTool()
            )
            self.register_tool("persona_explain", PersonaExplainTool())
            self.register_tool(
                "digitalad_personalization", DigitalAdPersonalizationTool()
            )
