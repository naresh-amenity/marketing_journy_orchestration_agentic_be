    ...
    async def execute(self, parameters: Dict[str, Any]) -> ToolResponse:
        ...
        try:
            ...
            if persona_name:
                ...
                for summary in persona_summaries:
                    if (
                        ...
                        and summary.get("persona_name") == persona_name
                    ):
                ...
                if specific_persona:
                    ...
                    return ToolResponse(
                        status="success",
                        message=message,
                        data={"personas": persona_names, "model_id": model_id},
                    )
            ...
            return ToolResponse(
                status="success",
                message=message,
                data={"personas": formatted_personas, "model_id": model_id},
            )
